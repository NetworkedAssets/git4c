var Git4CRestoreDefaultGlobsWarning = {
    getComponent: function (Events) {
        return {
            template: '<section role="dialog" id="restore_default_globs-dialog" class="aui-layer aui-dialog2 aui-dialog2-warning aui-dialog2-small" aria-hidden="true">' +
            '<!-- Dialog header -->' +
            ...
            methods: {
                ...
                confirmRestoreDefaultGlobs: function () {
                    this.$emit("closeRestoreDefaultGlobsWarning")
