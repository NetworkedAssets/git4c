var Git4CRemoveRepositoryWarning = {
    getComponent: function (Events) {
        return {
            ...
            template: '<section role="dialog" id="remove_repository-warning" class="aui-layer aui-dialog2 aui-dialog2-warning aui-dialog2-small" aria-hidden="true">' +
            '<!-- Dialog header -->' +
            ...
            '    <p style="text-align: center"><b>All of the Git Viewer for Confluence macros using this repository will stop working</b>.</p>' +
            '</div>' +
            '<!-- Dialog footer -->' +
