    ...
    getComponent: function (Events) {
        ...
        return {
            ...
            template:
                   ...
                   '                <label for="doc_macro-glob_name">Name</label>'+
                   '                <input id="doc_macro-glob_name" v-model="name" class="text" type="text" placeholder="Filter name">'+
                   '                <div class="description">Please type the filter\'s name</div>'+
                   '             </div>'+
                   '             <div class="field-group">'+
                   '                <label for="doc_macro-glob_pattern">Pattern</label>'+
                   '                <input id="doc_macro-glob_pattern" v-model="pattern" class="text" type="text" placeholder="Filter pattern">'+
                   '                <div class="description">Please type the <a id="new-glob-dialog-tooltip" href="https://docs.oracle.com/javase/tutorial/essential/io/fileOps.html#glob">pattern</a></div>'+
                   '             </div>'+
                   '      </div>'+
                   '      </div>'+
                   '      </div>'+
