 ...
 * Modifications copyright (C) 2017 NetworkedAssets
 *
...
public class Patterns {
    ...
    private static final String NA_CHARS = "[" +
            //{
            "\u007B" +
            //}
            "\u007D" +
    ...
    /**
     * Valid characters for IRI label defined in RFC 3987 with some special characters used by NetworkedAssets.
     */
    private static final String LABEL_CHAR = "a-zA-Z0-9" + UCS_CHAR + NA_CHARS;

    /**
     * Valid characters for IRI TLD defined in RFC 3987 with some special characters used by NetworkedAssets.
     */
    private static final String TLD_CHAR = "a-zA-Z" + UCS_CHAR + NA_CHARS;
    ...
    //We also allow hostnames without TLD
    private static final String HOST_NAME = "(" + IRI_LABEL + "\\.)+" + TLD;
    private static final String HOST_NAME_OPTIONAL_TLD = IRI_LABEL;

    private static final String DOMAIN_NAME_STR = "(" + HOST_NAME + "|" + IP_ADDRESS_STRING + ")";
    private static final String DOMAIN_NAME_STR_OPTIONAL_TLD = "(" + HOST_NAME_OPTIONAL_TLD + "|" + IP_ADDRESS_STRING + ")";
    ...
    public static final Pattern WEB_URL = Pattern.compile("("
            + "("
            + "(?:" + PROTOCOL + "(?:" + USER_INFO + ")?" + ")?"
            //Allow full domain with optional port or domain without tld with forced port or forced path and query
            + "("
            //Forced tld + optional port + optional path
            + "(?:" + DOMAIN_NAME_STR + ")"
            + "(?:" + PORT_NUMBER + ")?"
            + "(" + PATH_AND_QUERY + ")?"
            + "|"
            //Optional tld + forced port + optional path
            + "(?:" + DOMAIN_NAME_STR_OPTIONAL_TLD + ")"
            + "(?:" + PORT_NUMBER + ")"
            + "(" + PATH_AND_QUERY + ")?"
            + "|"
            //Optional tld + optional port + forced path
            + "(?:" + DOMAIN_NAME_STR_OPTIONAL_TLD + ")"
            + "(?:" + PORT_NUMBER + ")?"
            + "(" + PATH_AND_QUERY + ")"
            + ")"
