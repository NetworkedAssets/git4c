...
class DocItemTreefierTest extends Specification {
    ...
    def "should create tree from doc items"() {
        ...
        */
        ...
        DocumentationsContentTree root = DocumentsTreeConverter.treeify(docItems)
        ...
        and: "dir2"
        dir2.fullName == "doc/dir2"
        dir2.name == "dir2"
        dir2.type == DIR
        dir2.children.size() == 1
        DocumentationsContentTree dir21 = dir2.children[0]

        and: "dir21"
        dir21.fullName == "doc/dir2/dir21"
        dir21.name == "dir21"
        dir21.type == DIR
        dir21.children.size() == 1
        DocumentationsContentTree file211 = dir21.children[0]
