...
class GlobFilterPluginTest extends Specification {
    ...
    def "everything in subfolder test"() {
        ...
        files2.collect {
            it.path
        }.sort() == ["subfolder/file2.md", "subfolder/file3.md", "subfolder/subsubfolder/file4.png"].sort()


    }

    def "multiple globs test"() {

        given:
        def filter = new GlobFilterPlugin(["subfolder/**", "file1.md"])
        ...
        files2.collect {
            it.path
        }.sort() == ["subfolder/file2.md", "subfolder/file3.md", "subfolder/subsubfolder/file4.png", "file1.md"].sort()
    }
